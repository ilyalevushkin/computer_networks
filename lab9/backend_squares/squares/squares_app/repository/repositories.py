...
class FriendsCRUD:
    ...
    def update_note2(self, friend_pk, users_pk, ready_to_play):
        return self.objects.update_note(friend_pk, users_pk, ready_to_play)
...
class GamesCRUD:
    ...
    def get_active_note_by_users_pk(self, users_pk):
        return self.objects.get_notes_by_users_pk(users_pk, status='-1').first()

    def get_notes_by_users_pk(self, users_pk):
        return self.objects.get_notes_by_users_pk(users_pk, status='any')
