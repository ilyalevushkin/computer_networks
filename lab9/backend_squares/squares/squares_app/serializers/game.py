...
class GameStatesSerializer(serializers.Serializer):
    status = serializers.CharField(read_only=True, max_length=2)
    turn = serializers.CharField(max_length=1)
    player_1_points = serializers.IntegerField(read_only=True)
    player_2_points = serializers.IntegerField(read_only=True)
